...
from core_api.schemas.activity import (
    ActivityBase,
    ActivityCreate,
    ActivityUpdate,
    ActivityResponse,
)  # noqa: F401
from core_api.schemas.meal import MealBase, MealCreate, MealUpdate, MealResponse  # noqa: F401
...
from core_api.schemas.trip import (
    TripBase,
    TripCreate,
    TripUpdate,
    TripResponse,
