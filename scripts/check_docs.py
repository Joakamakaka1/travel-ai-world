...
REQUIRED = [
    ...
    "backend/README.md",
    "backend/AGENTS.md",
    "backend/libs/travel_common/README.md",
    "backend/services/core_api/README.md",
    "backend/services/core_api/AGENTS.md",
    "backend/services/core_api/.env.example",
    "backend/services/ai_api/README.md",
    "backend/services/ai_api/AGENTS.md",
    "backend/services/ai_api/.env.example",
    "frontend/README.md",
    "frontend/AGENTS.md",
